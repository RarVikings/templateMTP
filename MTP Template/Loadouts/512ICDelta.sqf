...
//this addAction["<t color='#38c12e'>5-1 Delta</t>", {player execVM "Loadouts\RecceMarksman.sqf";}, [],8,false,false,"","_this distance _target < 10"];
...
_this addPrimaryWeaponItem "UK3CB_BAF_LLM_Flashlight_Black";
...
hint "5-1 Delta kit successfully loaded!";
sleep 15;
hintSilent "";
